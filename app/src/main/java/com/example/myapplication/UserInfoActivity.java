...
public class UserInfoActivity extends AppCompatActivity {
    ...
    private void handleAuthorizationResponse(Intent intent) {
        ...
        String secret = "identity_admin_api_swaggerui";
    ...
    private void callUserInfo(){
        ...
        executor.submit(() -> {
            try {
                URL userInfoEndpoint = new URL("https://identitysts.azurewebsites.net/connect/userinfo");
                ...
                accesstokenview.setText(decodeIDToken(accessToken));
                idtokenview.setText(decodeIDToken(accessToken));

                username.setText(json.getString("name"));
                useremailId.setText(json.getString("preferred_username"));
                textviewuser.setText(json.getString("name"));
    ...
    public class LogoutListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            String logout_uri = "https://identitysts.azurewebsites.net/connect/endsession";
