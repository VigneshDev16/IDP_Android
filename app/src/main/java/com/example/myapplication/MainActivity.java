    ...
    public class AuthorizeListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            AuthorizationServiceConfiguration serviceConfiguration = new AuthorizationServiceConfiguration(
                    Uri.parse("https://identitysts.azurewebsites.net/connect/authorize") /* auth endpoint */,
                    Uri.parse("https://identitysts.azurewebsites.net/connect/token") /* token endpoint */
            );
            String clientId = "identity_admin_api_swaggerui";
            ...
            builder.setScopes("openid","profile","identity_admin_api");
